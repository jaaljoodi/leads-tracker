...
Overview
This is a lead tracker web application that I created in collaboration with my Scrimba tutor. In this project, I learned how to use various JavaScript concepts such as addEventListener(), input.value, function parameters, template strings, localStorage, and JSON objects.
